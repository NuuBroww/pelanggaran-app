    ...
    $routes->get('pelanggaran/update_pelanggaran/(:any)/(:any)', 'Pelanggaran::update_pelanggaran/$1/$2');
...
// ===== ADMIN LOGIN (ALIAS) =====
$routes->get('/admin_login', 'Admin::index'); // Tambahkan ini

// ===== USER VIEW (PUBLIC) =====
$routes->get('/user_view', 'Umum::index'); // Tambahkan ini
$routes->get('/public', 'Umum::index'); // Alternatif