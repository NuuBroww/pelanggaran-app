    ...
    public function index()
{
    ...
    $data = [
        ...
        'totalPelanggaranGanjil' => $totalPelanggaranGanjil, // TAMBAH INI
        'totalPelanggaranGenap' => $totalPelanggaranGenap,   // TAMBAH INI
    ...
    /**
     * API untuk ambil detail pelanggaran santri
     */
